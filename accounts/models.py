...
class UserManager(BaseUserManager):
    def create_user(self,first_name,last_name,username,email,password=None):
        ...
        if not username:
            raise ValuError('User must have username!!')
        user=self.model(
...
def post_save_profile_create_reciever(sender,instance,created,**kwargs):
    print(created)
    if created:
        ...
        try:
            ...
            UserProfile.objects.create(user=instance)
            print('userprofile is created for existing user!!!')
@receiver(pre_save,sender=User)
def pre_save_profile_reciever(sender,instance,**kwargs):
    print(instance,'is saved')


#post_save.connect(post_save_profile_create_reciever,User)
